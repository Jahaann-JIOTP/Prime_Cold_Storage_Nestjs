...
import { Compressor2Document } from './schemas/condensorpump.schema';
import { Getcompressor2Dto } from './dto/get-compressor.dto';


@Injectable()
export class Compressor4Service {
  private readonly Compressor2Keys = ['U4_Active_Energy_Total_Consumed'];

  constructor(
    @InjectModel('Compressor4') private readonly compressorModel: Model<Compressor2Document>,
  ) {}
